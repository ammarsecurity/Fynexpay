...
public static class LandingDefaults
{
    ...
    public static LandingLocaleDto Arabic() => new()
    {
        ...
        Login = "دخول",
        StartNow = "ابدأ الآن ←",
        Badge = "مدفوعات محلية بتكامل واحد — اقرأ التفاصيل",
        HeroTitle = "محطة دفع واحدة للتجار في العراق",
        HeroBefore = "محطة دفع واحدة",
        HeroAccent = "للتجار",
        HeroAfter = "في العراق",
        HeroSubtitle = "اربط متجرك أو تطبيقك بواجهة واحدة، امنح كل تاجر محفظة، وخذ عمولتك تلقائياً من كل عملية ناجحة.",
    ...
    public static LandingLocaleDto English() => new()
    {
        ...
        Badge = "Local payments, one integration — learn more",
        HeroTitle = "One payment hub for merchants in Iraq",
        HeroBefore = "One payment hub",
        HeroAccent = "for merchants",
        HeroAfter = "in Iraq",
        HeroSubtitle = "Connect your store or app with one API, give every merchant a wallet, and take your fee automatically on every successful payment.",
